  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        child: FutureBuilder(
          future: tasks, 
          builder: (BuildContext context, AsyncSnapshot<List<TodoListModel>> snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return Card(
                    child: ListTile(
                      onTap: () {
                        LoggerService.info('Tapped on ${snapshot.data![index]}');
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => TasksScreen(snapshot.data![index].listId),  
                        ));
                      },
